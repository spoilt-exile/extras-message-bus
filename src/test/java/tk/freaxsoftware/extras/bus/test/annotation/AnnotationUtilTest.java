...
public class AnnotationUtilTest {
    ...
    public void testMessage() {
        MessageBus.fire(TestReceiver.TEST_MESSAGE, null, null, MessageOptions.Builder.newInstance().ensure().callback((res) -> {
    ...
    public void testMessageError() {
        MessageBus.fire(TestReceiver.TEST_MESSAGE_ERROR, null, null, MessageOptions.Builder.newInstance().ensure().callback((res) -> {
            Assert.notNull(res.getContent());
        }).build());
    }
}
