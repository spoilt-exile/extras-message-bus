...
public class ServerConfig {
    ...
    private Integer sparkThreadPoolMinSize;
    ...
    public Integer getSparkThreadPoolMinSize() {
        return sparkThreadPoolMinSize;
    }

    public void setSparkThreadPoolMinSize(Integer sparkThreadPoolMinSize) {
        this.sparkThreadPoolMinSize = sparkThreadPoolMinSize;
    }
